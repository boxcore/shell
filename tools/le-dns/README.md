...
fork from : <https://github.com/xdtianyu/scripts/tree/master/le-dns>

the nginx setting usage maybe as:
...
server
{
    listen 443;
    ssl on;
    ssl_certificate     /home/wwwroot/ssl/ls-dns/certs/{Your Domain}/fullchain.pem;
    ssl_certificate_key /home/wwwroot/ssl/ls-dns/certs/{Your Domain}/privkey.pem;
