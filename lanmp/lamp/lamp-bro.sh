...
# install zlib
echo "#============================================================================#"
echo "Install zlib(if set prefix, that ever step must set --with-zlib-dir={dir})	"
echo "#============================================================================#"
...
# depand zlib:--with-zlib-dir=/usr/local/zlib
cd $cur_dir
...
cd php-5.2.6/
# depand by --with-zlib-dir=/usr/local/zlib
